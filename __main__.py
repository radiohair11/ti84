...
from src.configs import WINDOW_SIZE_X, WINDOW_SIZE_Y
...
class CalculatorWindow(QMainWindow):
    ...
    def _createButtons(self):
        ...
        layout.addWidget(
            get_button(UP_ARROW, style=WHITE_BUTTON_STYLE), 1, 3, 1, 2
        )  # up arrow
        ...
        layout.addWidget(get_button(LEFT_ARROW, style=WHITE_BUTTON_STYLE), 2, 3)
        layout.addWidget(get_button(RIGHT_ARROW, style=WHITE_BUTTON_STYLE), 2, 4)
        ...
        layout.addWidget(get_button(DOWN_ARROW, style=WHITE_BUTTON_STYLE), 3, 3, 1, 2)
        ...
        layout.addWidget(get_button("x" + SUPER_MINUS + SUPER_ONE), 5, 0)
        ...
        layout.addWidget(get_button("x" + SUPER_TWO), 6, 0)
        layout.addWidget(get_button(","), 6, 1)
        layout.addWidget(get_button("("), 6, 2)
        layout.addWidget(get_button(")"), 6, 3)
        layout.addWidget(get_button(DIVISION, style=WHITE_BUTTON_STYLE), 6, 4)
        ...
        layout.addWidget(get_button(MULTIPLY, style=WHITE_BUTTON_STYLE), 7, 4)
        ...
        layout.addWidget(get_button("STO" + RIGHT_ARROWHEAD), 9, 0)
